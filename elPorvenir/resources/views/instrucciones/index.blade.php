...
@section('pageTitle', "Instrucciones")
@section('mainContent')
...
@endif
    <div class='bg-white container my-4 p-3 bg-light shadow-sm  bg-body rounded'>
        ...
        <table class="table table-hover px-3">
            ...
            <thead>
                <tr>
                    ...
                    <th class="text-wrap" scope="col">Descripcion</th>
                </tr>
            </thead>
            <tbody id = "usuarios">
                ...
                <tr scope="row">
                    ...
                    <td>
                        <a href="{{ url('/instrucciones/'.$item->id.'/show ') }}">
                            <button type="button"
                        ...
                        <a href="{{ url('/instrucciones/'.$item->id.'/edit') }}">
                            <button type="button"
                        ...
                        <form action="{{ url('/instrucciones/'.$item->id) }}" method="post">
                            @csrf
                            {{ method_field('DELETE')}}
        ...
        @else
        <div>
            <h4 class="text-center my-3">No hay instrucciones disponibles</h4>
        </div>
        @endif
        </div>
