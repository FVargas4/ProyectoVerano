        ...
        <div class="container mt">
            ...
            <div class="form-group">
                ...
                <div class="mb-3 form-group form-outline">
                    <label for="prioridad_id" class="px-0">Selecciona el nivel de prioridad de la instrucción: <span aria-hidden="true" class="required text-danger" >*</span></label>
                ...
                <div class='col'>
                <div class="mb-3 form-group form-outline">
                    <label for="user_id" class="px-0">Selecciona un usuario a quien se le asignara la instrucción: <span aria-hidden="true" class="required text-danger" >*</span></label>
